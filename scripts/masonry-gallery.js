...
var MasonryGallery = (function () {
    ...
    function MasonryGallery(options) {
    ...
    _createClass(MasonryGallery, [{
        ...
        key: '_generateImageElementContainer',
        value: function _generateImageElementContainer(imageData, imagePositionData, imageIdx) {
        ...
        key: '_getImagePositionData',
        value: function _getImagePositionData(imageType) {
        ...
        key: '_updateGridOffsets',
        value: function _updateGridOffsets(imagePositionData) {
        ...
        key: '_triggerImageSelectedEvent',
        value: function _triggerImageSelectedEvent(e) {
        ...
        key: 'getElementImageIndex',
        value: function getElementImageIndex(targetElement) {
            return parseInt(targetElement.getAttribute('data-image-index'), 10);
        }
    }, {
        key: 'getImageContainerFromUIElement',
        value: function getImageContainerFromUIElement(uiElement) {
