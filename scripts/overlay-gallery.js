...
var OverlayGallery = (function () {
    function OverlayGallery(options) {
        _classCallCheck(this, OverlayGallery);
    ...
    _createClass(OverlayGallery, [{
        key: 'setGalleryActive',
        value: function setGalleryActive(bool) {
        ...
        key: 'setGalleryVisible',
        value: function setGalleryVisible(bool) {
        ...
        key: 'openGalleryOnEvent',
        value: function openGalleryOnEvent(eventData) {
        ...
        key: 'generateGalleryElement',
        value: function generateGalleryElement() {
        ...
        key: 'getElementTargetByImageIndex',
        value: function getElementTargetByImageIndex(imageIndex) {
            return this.galleryElements[imageIndex];
        }
    }, {
        key: 'setImageLikedFromEvent',
        value: function setImageLikedFromEvent(e) {
        ...
        key: 'setPhotoLiked',
        value: function setPhotoLiked(imageContainer, bool) {
        ...
        key: '_generateGalleryImageContainer',
        value: function _generateGalleryImageContainer(imageData, imageIndex) {
        ...
        key: '_bindGalleryImageEvents',
        value: function _bindGalleryImageEvents(imageContainer) {
        ...
        key: '_handleLikedUIClicked',
        value: function _handleLikedUIClicked(imageContainer, e) {
